...
return array(
		...
		*/
		...
		"between"          => array(
			...
			'array'   => 'O campo :attribute deve conter :min and :max itens.',

		),
		'boolean'           => 'O campo :attribute  deve ter valor verdeiro ou falso.',
		...
		'json'             => 'Campo  :attribute deve conter uma string JSON válida.',
		"max"              => array(
